export const eventList = [
    ...
    {
  id: 6,
  heading: "Global Tech Innovators Summit",
  date: { year: 2024, month: "March" },
  location: "Bengaluru, India",
  description:
    "Join the brightest minds in the industry at the Global Tech Innovators Summit. From groundbreaking AI tools to sustainable robotics, this summit is a melting pot of futuristic ideas. Network with industry pioneers, attend insightful keynotes, and explore tech demos that are reshaping the future.",
  img: "https://moderndiplomacy.eu/wp-content/uploads/2018/04/digitaltransformation.jpg",
},

{
  id: 7,
  heading: "World Cultural Festival",
  date: { year: 2025, month: "November" },
  location: "New Delhi, India",
  description:
    "Celebrate diversity at the World Cultural Festival, a mesmerizing event showcasing traditions, art, dance, and cuisine from across the globe. Witness the harmony of cultures as thousands gather for an unforgettable celebration of humanity.",
  img: "https://images.hindustantimes.com/img/2021/02/19/550x309/20171226180052_383_1_1613743373600_1613743381781.jpg"
,
},

{
  id: 8,
  heading: "Green Future Expo",
  date: { year: 2024, month: "August" },
  location: "Pune, India",
  description:
    "The Green Future Expo is your destination to explore sustainable solutions. From electric mobility and eco-friendly housing to clean energy startups, the expo drives impactful conversations and actions for a better planet. Be part of the change today!",
  img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=600&q=60",
},

{
  id: 9,
  heading: "National Book Carnival",
  date: { year: 2025, month: "January" },
  location: "Kolkata, India",
  description:
    "Lose yourself in the pages of thousands of books at the National Book Carnival. Meet your favorite authors, discover rare finds, and indulge in workshops that awaken your literary spirit. A paradise for every book lover!",
...
{
  id: 10,
  heading: "NextGen Gamers Arena",
  date: { year: 2024, month: "September" },
  location: "Hyderabad, India",
  description:
    "Step into the world of virtual thrills at the NextGen Gamers Arena. Compete in esports tournaments, test unreleased games, and connect with popular streamers and game developers. Whether you're a casual player or a pro, this is your ultimate gaming hub.",
  img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtSBoLG0kMVWznz-RU1Uqr2sbQegG75DFAxw&s",
},
